...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'You are ready to accept deliveries'**
  ...
  /// Section title for current deliveries
  ///
  /// In en, this message translates to:
  /// **'Current Deliveries'**
  String get currentDeliveries;

  /// Message when there are no deliveries
  ///
  /// In en, this message translates to:
